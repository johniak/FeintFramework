...
{
    public class WhereBuilderDynamic
    {
        ...
        QueryBuilderDynamic queryBuilder;
        public WhereBuilderDynamic(QueryBuilderDynamic queryBuilder,Type t)
        {
            this.t = t;
            getAllForeginesDependencies(t);
        ...
        /// <returns></returns>
        public WhereBuilderDynamic Eq(string column, object value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public WhereBuilderDynamic Lt(string column, object value)
        {
            convertParameters(ref column, ref value);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public WhereBuilderDynamic Gt(string column, object value)
        {
            convertParameters(ref column, ref value);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public WhereBuilderDynamic Le(string column, object value)
        {
            convertParameters(ref column, ref value);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public WhereBuilderDynamic Ge(string column, object value)
        {
            convertParameters(ref column, ref value);
        ...
        /// </summary>
        /// <returns></returns>
        public WhereBuilderDynamic And()
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public WhereBuilderDynamic Like(string column, object value)
        {
            convertParameters(ref column, ref value);
        ...
        public WhereBuilderDynamic Limit(long count)
        {
            limitStart = -1;
            limitCount = count;
            return this;
        }
        public WhereBuilderDynamic Limit(long start, long count)
        {
            limitStart = start;
            limitCount = count;
            return this;
        ...
        private void convertParameters(ref string column, ref object value)
        {
            ...
            {
                if (FeintORM.GetInstance().Helper.getDBType(t.GetProperty(column, BindingFlags.Public | BindingFlags.Instance).PropertyType) == null)
                {
                    int id = joins.Count;
					joins.Add(new DBJoinInformation() { Table = FeintORM.GetInstance().Prefix + t.GetProperty(column, BindingFlags.Public | BindingFlags.Instance).PropertyType.GetGenericArguments()[0].Name, Alias = column + id, LeftCollumn = "fk_" + column, RightCollumn = "Id" });
                    dynamic d = value;
                    column = column + id + ".Id";
                    value = d.Id;
                }
        ...
        /// </summary>
        /// <returns></returns>
        public List<DBModel> Execute()
        {

            Stopwatch timer = new Stopwatch();
            DataTable table;
            if (joins.Count == 0)
                table = FeintORM.GetInstance().Helper.Select(FeintORM.GetInstance().Prefix + t.Name, whereList,null,limitStart,limitCount,orderBy,ascending);
            else
                table = FeintORM.GetInstance().Helper.Select(FeintORM.GetInstance().Prefix + t.Name, whereList, joins, limitStart, limitCount, orderBy, ascending);
            timer.Start();
            var pr = getPropertiesFromClass(t); 
            var fr = getForeignersFromClass(t);

            List<DBModel> tets = new List<DBModel>(table.Rows.Count);
        ...
        public long Count()
        {
            long count=0;
            if (joins.Count == 0)
                count = FeintORM.GetInstance().Helper.Count(FeintORM.GetInstance().Prefix + t.Name, whereList, null);
            else
                count = FeintORM.GetInstance().Helper.Count(FeintORM.GetInstance().Prefix + t.Name, whereList, joins);
            return count;
        }

        public WhereBuilderDynamic OrderBy(string collumn, bool ascending)
        {
